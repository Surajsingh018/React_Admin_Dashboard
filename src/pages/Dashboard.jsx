        ...
        <main className="min-w-0">
          ...
          <section className="mb-6 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-200/60">
              <span className="text-sm font-bold text-slate-500">Total Products</span>
              <strong className="mt-3 block text-3xl font-bold text-slate-950">128</strong>
              <p className="mt-3 text-sm font-bold text-teal-700">12 added this week</p>
            </article>

            <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-200/60">
              <span className="text-sm font-bold text-slate-500">Total Users</span>
              <strong className="mt-3 block text-3xl font-bold text-slate-950">2,430</strong>
              <p className="mt-3 text-sm font-bold text-teal-700">8.4% growth</p>
            </article>

            <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-200/60">
              <span className="text-sm font-bold text-slate-500">Orders</span>
              <strong className="mt-3 block text-3xl font-bold text-slate-950">846</strong>
            ...
            <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-200/60">
              ...
              <strong className="mt-3 block text-3xl font-bold text-slate-950">$18.2k</strong>
              <p className="mt-3 text-sm font-bold text-teal-700">Updated today</p>
            </article>
          </section>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/60">
              ...
              <div className="grid gap-4">
                <div className="grid grid-cols-[12px_minmax(0,1fr)] gap-4 rounded-xl bg-slate-50 p-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900">New product uploaded</h3>
                    <p className="mt-1 text-sm leading-6 text-slate-500">Wireless headphones were added to inventory.</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[12px_minmax(0,1fr)] gap-4 rounded-xl bg-slate-50 p-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900">Order completed</h3>
                    <p className="mt-1 text-sm leading-6 text-slate-500">Order #2034 was marked as delivered.</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-[12px_minmax(0,1fr)] gap-4 rounded-xl bg-slate-50 p-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-slate-500">Smart watch inventory is running low.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/60">
              ...
              <div className="grid gap-4">
                <div className="flex flex-col gap-1 rounded-xl bg-slate-50 p-4 sm:flex-row sm:items-center sm:justify-between">
                  <span className="font-bold text-slate-900">Laptop Pro</span>
                  <strong className="text-sm font-bold text-teal-700">342 sales</strong>
                </div>
                <div className="flex flex-col gap-1 rounded-xl bg-slate-50 p-4 sm:flex-row sm:items-center sm:justify-between">
                  <span className="font-bold text-slate-900">Smart Watch</span>
                  <strong className="text-sm font-bold text-teal-700">289 sales</strong>
                </div>
                <div className="flex flex-col gap-1 rounded-xl bg-slate-50 p-4 sm:flex-row sm:items-center sm:justify-between">
                  <span className="font-bold text-slate-900">Headphones</span>
                  <strong className="text-sm font-bold text-teal-700">214 sales</strong>
                </div>
              </div>
            </div>
          </section>
